...
Tip: References works for the class component but not for function component (unless you use useRef hook, see [Other hooks](https://github.com/CherifYasmine/react-cheatsheet#other-hooks "other-hooks") )
